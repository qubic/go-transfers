...
const (
	TransferService_Health_FullMethodName                        = "/qubic.transfers.proto.TransferService/Health"
	TransferService_GetAssetEventsForTick_FullMethodName         = "/qubic.transfers.proto.TransferService/GetAssetEventsForTick"
	TransferService_GetAssetChangeEventsForTick_FullMethodName   = "/qubic.transfers.proto.TransferService/GetAssetChangeEventsForTick"
	TransferService_GetAssetChangeEventsForEntity_FullMethodName = "/qubic.transfers.proto.TransferService/GetAssetChangeEventsForEntity"
	TransferService_GetQuTransferEventsForTick_FullMethodName    = "/qubic.transfers.proto.TransferService/GetQuTransferEventsForTick"
	TransferService_GetQuTransferEventsForEntity_FullMethodName  = "/qubic.transfers.proto.TransferService/GetQuTransferEventsForEntity"
)
...
func (c *transferServiceClient) Health(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*HealthResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransferService_Health_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferServiceClient) GetAssetEventsForTick(ctx context.Context, in *TickRequest, opts ...grpc.CallOption) (*AssetEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransferService_GetAssetEventsForTick_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferServiceClient) GetAssetChangeEventsForTick(ctx context.Context, in *TickRequest, opts ...grpc.CallOption) (*AssetChangeEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransferService_GetAssetChangeEventsForTick_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferServiceClient) GetAssetChangeEventsForEntity(ctx context.Context, in *EntityRequest, opts ...grpc.CallOption) (*AssetChangeEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AssetChangeEventsResponse)
	err := c.cc.Invoke(ctx, TransferService_GetAssetChangeEventsForEntity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferServiceClient) GetQuTransferEventsForTick(ctx context.Context, in *TickRequest, opts ...grpc.CallOption) (*QuTransferEventsResponse, error) {
	...
	err := c.cc.Invoke(ctx, TransferService_GetQuTransferEventsForTick_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transferServiceClient) GetQuTransferEventsForEntity(ctx context.Context, in *EntityRequest, opts ...grpc.CallOption) (*QuTransferEventsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(QuTransferEventsResponse)
	err := c.cc.Invoke(ctx, TransferService_GetQuTransferEventsForEntity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TransferService_Health_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransferService_Health_FullMethodName,
	}
...
func _TransferService_GetAssetEventsForTick_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransferService_GetAssetEventsForTick_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransferService_GetAssetChangeEventsForTick_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransferService_GetAssetChangeEventsForTick_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransferService_GetAssetChangeEventsForEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransferService_GetAssetChangeEventsForEntity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransferService_GetQuTransferEventsForTick_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransferService_GetQuTransferEventsForTick_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TransferService_GetQuTransferEventsForEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransferService_GetQuTransferEventsForEntity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
